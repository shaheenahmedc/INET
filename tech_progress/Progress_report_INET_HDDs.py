...
plt.scatter(df_kurzweil_2005.index, df_kurzweil_2005["US $/Megabyte"], s = marker_size, label = "5")
...
plt.scatter(df_sood_2005_optical.index, df_sood_2005_optical["US $/Megabyte"], s = marker_size, label = "8")
plt.scatter(df_sood_2005_magneto_optical.index, df_sood_2005_magneto_optical["US $/Megabyte"], s = marker_size, label = "9")
